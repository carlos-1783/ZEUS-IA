...
# Fiscal models live in app.models.fiscal (re-exported for backward compatibility).
from app.models.fiscal import FiscalProfile, TaxRate, TPVSale, TPVSaleItem  # noqa: F401
